            ...
            <ul>
                ...
                <li>
                    <div class="navigationLinks">
                        ...
                        <a href="adminDashboard.html"><p style="margin-left: 0.3rem;">Dashboard</p></a>
                    </div>
                </li>
                <!-- Candidates -->
                <li>
                    ...
                    <a href="adminRepresentativesPage.html"><p>Candidates</p></a>
                    </div>
                    </li>
                    <!-- students -->
                    <li>
                        <div class="navigationLinks">
                            ...
                            <a href="adminStudentDashboard.html"><p style="margin-left: 0.3rem;">Students</p></a>
                        </div>
                    </li>
                <!-- statistics -->
                <li>
                    <div class="navigationLinks">
                        ...
                        <a href="adminStatisticPage.html"><p>Statistics</p></a>
                    </div>
                </li>
                <!-- administrators -->
                <li>
                    <div class="navigationLinks">
                        ...
                        <a href="addAdminPage.html"><p>Administrators</p></a>
                    </div>
                </li>
            </ul>
            <!-- logout section -->
