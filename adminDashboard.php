...
<body>
    ...
    <section class="mainContainer">
        ...
        <div class="heroSection">
            ...
            <!-- top representatives -->
            <h4 style="margin-left: 2rem; margin-left: 3rem; margin-top: 1rem; font-family: 'Poppins', sans-serif; font-weight: 500; font-style: normal;">Top representatives</h4>
            <div class="repCarts">
                <div class="cart">
                    <h2 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-style: normal; color: #48805F; font-size: 2.2rem;">Teta Butati Lesly</h2>
                    <p>Presidential Position</p>
                    <div class="perProf">
                        <h1 style="font-size: 3.7rem;">98%</h1>
                        <img src="./Assets/Rectangle (1).png" alt="profile pic" height="100px" width="100px">
                    </div>
                </div>
            </div>
        </div>
